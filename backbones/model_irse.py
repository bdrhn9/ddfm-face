...
class Backbone(Module):
    def __init__(self, input_size, num_layers, num_classes=285, mode="ir"):
        super(Backbone, self).__init__()
        assert input_size in [
            32,
            112,
            224,
        ], "input_size should be [32, 32], [112, 112] or [224, 224]"
        ...
        if input_size == 112:
            ...
            raise "something goes wrong with input size"
...
def IR_50(pretrained, input_size=112, num_classes=285):
    """Constructs a ir-50 model."""
    model = Backbone(input_size, 50, num_classes)
    if pretrained:
        checkpoint_ = torch.load("./modules/backbones/backbone_ir50_ms1m_epoch63.pth")
