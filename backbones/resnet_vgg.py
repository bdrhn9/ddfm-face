...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 22 15:49:48 2021
...
def load_state_dict(
    model,
    fname="/home/mlcv/bdrhn9_ws/cvpr2021/ddfm-face/backbones/resnet50_ft_weight.pkl",
):
    """
            ...
            try:
                ...
                raise RuntimeError(
                    ...
                    "dimensions in the checkpoint are {}.".format(
                        name, own_state[name].size(), param.shape
                    )
                )
        else:
...
# model_example = resnet50()
# out=model_example(torch.zeros((5,3,224,224)))
